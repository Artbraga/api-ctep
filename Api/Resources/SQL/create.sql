...
-- Schema ctep
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ctep` DEFAULT CHARACTER SET utf8 ;
USE `ctep` ;
...
-- Table `ctep`.`tb_aluno`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ctep`.`tb_aluno` ;

CREATE TABLE IF NOT EXISTS `ctep`.`tb_aluno` (
  ...
  `ano_matricula` INT(2) NULL,
  `data_matricula` DATE NOT NULL,
  `data_nascimento` DATE NOT NULL,
  `data_validade` DATE NULL,
  `curso_anterior` VARCHAR(20) NULL,
...
-- -----------------------------------------------------
-- Table `ctep`.`tb_professor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ctep`.`tb_professor` ;

CREATE TABLE IF NOT EXISTS `ctep`.`tb_professor` (
...
-- -----------------------------------------------------
-- Table `ctep`.`tb_usuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ctep`.`tb_usuario` ;

CREATE TABLE IF NOT EXISTS `ctep`.`tb_usuario` (
  ...
  CONSTRAINT `fk_tb_usuario_ALUNO1`
    ...
    REFERENCES `ctep`.`tb_aluno` (`id_aluno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_usuario_tb_professor1`
    FOREIGN KEY (`id_professor`)
    REFERENCES `ctep`.`tb_professor` (`id_professor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `ctep`.`tb_curso`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ctep`.`tb_curso` ;

CREATE TABLE IF NOT EXISTS `ctep`.`tb_curso` (
  ...
  CONSTRAINT `fk_CURSO_CURSO1`
    ...
    REFERENCES `ctep`.`tb_curso` (`id_curso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ctep`.`tb_tpstatus_turma`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ctep`.`tb_tpstatus_turma` ;

CREATE TABLE IF NOT EXISTS `ctep`.`tb_tpstatus_turma` (
  `id_tpstatus_turma` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(20) NOT NULL,
...
-- Table `ctep`.`tb_turma`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ctep`.`tb_turma` ;

CREATE TABLE IF NOT EXISTS `ctep`.`tb_turma` (
  ...
  CONSTRAINT `fk_TURMA_TPSTATUS_TURMA1`
    ...
    REFERENCES `ctep`.`tb_tpstatus_turma` (`id_tpstatus_turma`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ctep`.`tb_turma_aluno`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ctep`.`tb_turma_aluno` ;

CREATE TABLE IF NOT EXISTS `ctep`.`tb_turma_aluno` (
  `id_turma_aluno` INT NOT NULL AUTO_INCREMENT,
  `matricula_aluno` VARCHAR(8) NOT NULL,
  `data_conclusao` DATE NULL,
  `codigo_conlusaosistec` VARCHAR(30) NULL,
  ...
  CONSTRAINT `fk_ALUNO_has_TURMA_TURMA1`
    ...
    REFERENCES `ctep`.`tb_turma` (`id_turma`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ctep`.`tb_registro_aluno`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ctep`.`tb_registro_aluno` ;

CREATE TABLE IF NOT EXISTS `ctep`.`tb_registro_aluno` (
  ...
  CONSTRAINT `fk_tb_observacaoaluno_tb_aluno1`
    FOREIGN KEY (`id_aluno`)
    REFERENCES `ctep`.`tb_aluno` (`id_aluno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `ctep`.`tb_registro_turma`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ctep`.`tb_registro_turma` ;

CREATE TABLE IF NOT EXISTS `ctep`.`tb_registro_turma` (
  ...
  CONSTRAINT `fk_OBSERVACAO_TURMA_TURMA1`
    FOREIGN KEY (`id_turma`)
    REFERENCES `ctep`.`tb_turma` (`id_turma`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `ctep`.`tb_turma_professor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ctep`.`tb_turma_professor` ;

CREATE TABLE IF NOT EXISTS `ctep`.`tb_turma_professor` (
...
-- -----------------------------------------------------
-- Table `ctep`.`tb_disciplina`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ctep`.`tb_disciplina` ;

CREATE TABLE IF NOT EXISTS `ctep`.`tb_disciplina` (
