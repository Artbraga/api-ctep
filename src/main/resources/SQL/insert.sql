...
INSERT INTO CURSO (ID, NOME, SIGLA, SIGLA_TURMA, ESPECIALIZACAO, CURSO_VINCULADO) VALUES
  (1, 'T�cnico de Enfermagem', 'ENF', 'TENF', FALSE, NULL),
  (2, 'Especializa��o em Instrumenta��o Cir�rgica', 'EIC', 'ETIC', TRUE, 1);

INSERT INTO ALUNO (MATRICULA, NOME, CPF, ENDERECO, CEP, ANO_MATRICULA, DATA_MATRICULA, CURSO_ID, NOTA_FISCAL, STATUS) VALUES
  ('EIC17001', 'Arthur Bastos Braga Coelho', '12480014789', 'Rua Embaixador Ram�n Carcano 95', '20210030', 17,'2017-12-10', 2, 0, 1),
  ...
  ('EIC17010', 'Christian Bernard da Silva Loureiro', '97114967047', 'Rua Noronha Torres�o 87', '88543254', 17, '2017-02-19', 2, 0, 1),
  ...
  ('EIC17013', 'Jo�o Victor Domingos Borges', '92081655071', 'Rua Taberna Molhada 54', '67792538', 17, '2017-08-21', 2, 0, 1),
  ('EIC17014', 'Thiago Martins Ventura', '03506849018', 'Rua Tabu�o da Serra 69', '81760142', 17, '2017-05-23', 2, 0, 1),
  ('EIC17015', 'Val�ria Christina da Silva', '46470737005', 'Rua Sergio Motta 23', '34638536', 17, '2017-03-04', 2, 0, 1),
  ('EIC17016', 'F�tima Bernardes Exbonner', '06927736069', 'Travessa Carilhos Brown 45', '43573285', 17, '2017-10-05', 2, 0, 1),
  ...
  ('EIC17020', 'Gelson Platutino Junior', '88194187036', 'ladeira do Neg�o 22', '34354632', 17, '2017-05-17', 2, 0, 1),
  ...
  ('EIC17024', 'Sophia Rebelde Abrah�o', '10489138055', 'Estrada Rebelde Brasi 01', '35556432', 17, '2017-09-21', 2, 0, 1),
  ...
  ('ENF17003', 'Raquel Gomes Pereira', '25209206025', 'Praia de Maraj�s 999', '92874823', 17, '2017-03-24', 1, 0, 1),
  ...
  ('ENF17011', 'Clover Esp�ndola Javas', '37913336072', 'Rua Woop 34', '45675329', 17, '2017-06-14', 1, 0, 1),
  ...
  ('ENF17014', 'Rickin Martin Bernard', '12842841077', 'Rua do Mist�rio 49', '32467670', 17, '2017-02-28', 1, 0, 1),
  ...
  ('ENF17022', 'Gabriel Gouveia Santos', '08324034072', 'Avenida Atl�ndida 171', '56542344', 17, '2017-09-10', 1, 0, 1),
  ('ENF17023', 'Pablo Pinto Vittar', '97972074046', 'Ladeira do Meu Cora��o', '35579045', 17, '2017-07-15', 1, 0, 1),
  ...
  ('ENF17026', 'Ruth Gomes Pereira', '83298834009', 'Praia de Maraj�s 999', '92874823', 17, '2017-03-24', 1, 0, 1),
...
INSERT INTO TURMA (CODIGO, DIAS_DA_SEMANA, HORA_INICIO, HORA_FIM, DATA_INICIO, DATA_FIM, ANO_INICIO, CURSO_ID, STATUS) VALUES
  ('ETIC1701', 'S�bados', '08:00', '12:00', '2017-01-01', NULL, 17, 2, 1),
  ('TENF1701', 'Ter�as e Quintas', '18:00', '21:00', '2017-03-12', '2019-05-21', 17, 1, 1),
...
INSERT INTO DISCIPLINA (NOME, CURSO_ID) VALUES
  ('Anatomia', 1),
  ('�tica', 1),
  ('Assist�ncia de Enfermagem � Crian�a e Adolescente', 1),
  ('Assist�ncia de Enfermagem � Sa�de da Mulher e Maternidade', 1),
  ('Sa�de Mental', 1),
  ('Sa�de Coletiva', 1),
  ('Sa�de P�blica', 1),
  ('Biosseguran�a das A��es de Enfermagem', 1),
  ('A��es de Enfermagem Para Seguran�a do Paciente', 1),
  ('Enfermagem Cir�rgica', 1),
  ('Epidemiologia', 1),
  ('Fundamentos de Enfermagem', 1),
  ('Enfermagem Cl�nica', 1),
  ('Urg�ncia e Emerg�ncia', 1)
;

INSERT INTO DISCIPLINA (NOME, CURSO_ID) VALUES
  ('Prova M�dulo 1', 2),
  ('Prova M�dulo 2', 2),
  ('Escova��o e Paramenta��o', 2),
  ('Mesa de Mayo', 2);
